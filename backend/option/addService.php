...
<body >
		...
		<div class="panel">
								...
								<form action="addServiceProcess.php" method="post" enctype="multipart/form-data">
									...
									<br>
								<input class="form-control input-lg" placeholder="简介" type="text" style="width: 40%;margin-left:30%; " name="intro">
									<br>
									...
									<div class="div1" style="margin-left: 30%;">
