...
<body onload="getb()">
		...
		<div class="panel">
								...
								<form action="updateNewProcess.php" method="post" enctype="multipart/form-data">
									<input class="form-control input-lg" placeholder="标题" type="text" style="width: 40%;margin-left:30%; " name="title" value="<?php echo $res[0][2]?>">
									<br>
								<input class="form-control input-lg" placeholder="作者" type="text" style="width: 40%;margin-left:30%; " name="editer" value="<?php echo $res[0][3]?>">
									<br>
