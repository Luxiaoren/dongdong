...
if($_FILES['file']['name']==""){
			    ...
			    $date=date("Y-m-d");
			      ...
			      $db=new dbHelper();
			      $sql="update $table set editer='$editer',title='$title',content='$content', uploadTime='$date' where id=$updateid";
			     ...
			     echo "<script type='text/javascript'>alert('修改成功');</script>$table";
		  		 echo '<script type="text/javascript">location.href="../iframe/comnews.php";</script>';
		  		 die();
}
		  ...
		  else
		    {
			    ...
			    if (file_exists("../image/" . $_FILES["file"]["name"]))
			     ...
			     // echo $unpath;
			      ...
			      $sql="update $table set imgPath='$path',intro='$intro',title='$title', content='$content',uploadTime='$date'  where id=$updateid";
//echo $sql;
