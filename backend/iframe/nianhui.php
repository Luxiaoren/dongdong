...
<head>
	...
	<script type="text/javascript">
		...
		function update(i){
				...
				window.location.href='../option/update.php?id='+i+'&d='+'nianhui'+'';
			}
			function deletefile(id){
				window.location.href='../option/deletefile.php?id='+id+'&table='+'nianhui'+'';
			}
	</script>
</head>
								...
								<div class="panel-body">
									<table class="table">
									    ...
									    <div class="div2">上传图片</div>
												...
												<th></th>
												<input type="hidden" name="page" value="nianhui">
