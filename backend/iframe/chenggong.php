...
<head>
	...
	<script type="text/javascript">
			function update(i){
				...
				window.location.href='../option/update.php?id='+i+'&d='+'chenggong'+'';
			}
			function deletefile(id){
				window.location.href='../option/deletefile.php?id='+id+'&table='+'chenggong'+'';
			}
	</script>
</head>
									...
									<table class="table">
										...
										<thead>
											<tr class="name1">
												...
												<th></th>
												<input type="hidden" name="page" value="chenggong">
