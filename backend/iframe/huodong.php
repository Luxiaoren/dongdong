...
<head>
	...
	<script type="text/javascript">
		...
		function update(i){
				...
				window.location.href='../option/update.php?id='+i+'&d='+'huodong'+'';
			}
			function deletefile(id){
				window.location.href='../option/deletefile.php?id='+id+'&table='+'huodong'+'';
			}
	</script>
</head>
								...
								<div class="panel-body">
									<table class="table">
									    ...
									    <input type="file" class="inputstyle" name="file" id="file">
												...
												<th></th>
												<input type="hidden" name="page" value="huodong">
