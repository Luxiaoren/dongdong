...
<div class="scd scd_a clearfix">
	<div class="scd_l">
    	<div class="name">关于冬冬<span>/about</span></div>
        <ul class="s_nav">
        	<li ><a href="about.php">公司简介</a></li>
            <li class="now"><a href="zhuyingyewu.html">主营业务</a></li>
        </ul>
    </div>
    <div class="scd_r">
    	<div class="scd_rh">
        ...
        <div class="scd_m">
               <h2>
                   工商注册号：<?php echo $res[0][7]?>
               </h2>
               <h2>组织机构代码：<?php echo $res[0][8]?></h2>
            <h2>统一信用代码：<?php echo $res[0][9]?></h2>
            <h2>企业类型：<?php echo $res[0][10]?></h2>
            <h2>行业：<?php echo $res[0][11]?>/h2>
            <h2>公司地址：<?php echo $res[0][5]?></h2>
            <h3>经营范围：<?php echo $res[0][12]?>
            </h3>
            <h2>主要人员：<?php echo $res[0][13]?></h2>
            <img src="Assets/images/zhuyingyewu1.jpg" width="300px" height="220px">
            <img src="Assets/images/zhuyingyewu2.jpg" width="300px" height="220px">
        </div>
    </div>
</div>
<!--主体盒子-->
